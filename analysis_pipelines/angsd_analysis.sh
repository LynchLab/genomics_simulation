...
angsd -HWE_pval_F 1 -out ../analysis_files/angsd_calls.vcf -bam bam_list.txt -minMapQ 7 -uniqueOnly 1 -doMajorMinor 5 -minMaf 0.001 -doMaf 1 -anc $name -GL 1 -nThreads 10 -doGlf 1
